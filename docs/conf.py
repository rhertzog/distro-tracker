...
htmlhelp_basename = 'DistroTrackerDoc'
...
latex_documents = [
  ('index', 'DistroTracker.tex', u'Distro Tracker Documentation',
   u'The Distro Tracker Developers', 'manual'),
]
...
man_pages = [
    ('index', 'distrotracker', u'Distro Tracker Documentation',
     [u'The Distro Tracker Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'DistroTracker', u'Distro Tracker Documentation',
   u'The Distro Tracker Developers', 'Distro Tracker', 'Synoptic of a Debian-based Distribution.',
   'Miscellaneous'),
]
