...
"""
Tests for the :mod:`pts.core.news_feed` module.
"""
...
from pts.core.models import ActionItemType
...
class NewsFeedTests(TestCase):
    ...
    def test_news_feed_action_item(self):
        """
        Tests that :class:`ActionItem <pts.core.models.ActionItem>` instances
    ...
    def test_news_feed_news_item(self):
        """
        Tests that :class:`News <pts.core.models.News>` instances are included
        in the news feed.
        """
