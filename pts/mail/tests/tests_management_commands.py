...
"""
Tests the management command of the :mod:`pts.mail` app.
"""
from __future__ import unicode_literals
from django.test import TestCase, TransactionTestCase
from pts.mail.management.commands.pts_unsubscribe_all import (
    Command as UnsubscribeCommand)
from pts.mail.management.commands.pts_dump_subscribers import (
    Command as DumpCommand)
from pts.mail.management.commands.pts_stats import Command as StatsCommand
