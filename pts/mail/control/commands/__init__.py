...
class CommandFactory(object):
    """
    Creates instances of :py:class:`Command <pts.mail.control.commands.base.Command>`
    ...
    def get_command_function(self, line):
        ...
        :rtype: :py:class:`Command <pts.mail.control.commands.base.Command>`
            subclass
        """
...
class CommandProcessor(object):
    ...
    def __init__(self, factory, confirmed=False):
        ...
        :param factory: Used to obtain
            :py:class:`Command <pts.mail.control.commands.base.Command>` instances
    ...
    def run_command(self, command):
        ...
        :type command: :py:class:`Command <pts.mail.control.commands.base.Command>`
        """
