...
"""
Tests for the :mod:`pts.stdver_warnings` app.
"""

from __future__ import unicode_literals
from django.test import TestCase
from django.utils.six.moves import mock
from pts.stdver_warnings.pts_tasks import UpdateStandardsVersionWarnings
from pts.core.tasks import Event, Job, JobState
...
class StandardsVersionActionItemTests(TestCase):
    """
    Tests for the
    :class:`pts.stdver_warnings.pts_tasks.UpdateStandardsVersionWarnings`
    task.
    """
    def setUp(self):
    ...
    def run_task(self, initial_task=False):
        ...
        :param initial_task: An optional flag which if ``True`` means that the
            ...
            :func:`pts.core.tasks.run_task` function.
    ...
    def get_action_type(self):
        """
        Returns the :class:`pts.core.models.ActionItemType` for
