...
urlpatterns = patterns('',
    ...
    url(r'^teams/(?P<pk>\d+)/\+delete/$', DeleteTeamView.as_view(),
    ...
    url(r'^teams/(?P<pk>\d+)/\+update/$', UpdateTeamView.as_view(),
        name='pts-team-update'),
    url(r'^teams/(?P<pk>\d+)/\+add-package/$', AddPackageToTeamView.as_view(),
        name='pts-team-add-package'),
    url(r'^teams/(?P<pk>\d+)/\+remove-package/$', RemovePackageFromTeamView.as_view(),
        name='pts-team-remove-package'),
    url(r'^teams/(?P<pk>\d+)/\+join/$', JoinTeamView.as_view(),
        name='pts-team-join'),
    url(r'^teams/(?P<pk>\d+)/\+leave/$', LeaveTeamView.as_view(),
        name='pts-team-leave'),
    url(r'^teams/(?P<pk>\d+)/\+add-member/$', AddTeamMember.as_view(),
        name='pts-team-add-member'),
    url(r'^teams/(?P<pk>\d+)/\+remove-member/$', RemoveTeamMember.as_view(),
        name='pts-team-remove-member'),
    url(r'^teams/(?P<pk>\d+)/\+manage/$', ManageTeamMembers.as_view(),
