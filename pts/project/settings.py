...
"""Django settings for the PTS project.

The settings in this module do not need to be changed for different PTS
deployments and they are independent from any environment in which the project
is deployed.
"""
